...
#IJMPQ instruction is added with the following stages:
...
# I add IJMPQ here to set it as a valid instruction
bool instr_valid = icode in 
	{ INOP, IHALT, IRRMOVQ, IIRMOVQ, IRMMOVQ, IMRMOVQ,
	       IOPQ, IJXX, ICALL, IRET, IPUSHQ, IPOPQ,IJMPQ };

# Does fetched instruction require a regid byte?
#Operations needs one register to jumping to it. 
bool need_regids =
...
#Register's value is needed to jump that value.
word srcA = [
...
#To determine the next instruciton, new_pc value should be updated to valA. 
word new_pc = [
